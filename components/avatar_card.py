...
def render_user_active_avatar(
    ...
    html = (
        ...
        f'<div class="avatar-ring" style="width:110px;height:110px;border-radius:50%;border:3px solid {accent};'
        f'margin:0 auto 8px;overflow:hidden;'
        f'box-shadow:0 0 30px {glow},0 0 60px {glow2};">'
        f'{img_tag}</div>'
        f'<div style="display:flex;justify-content:center;align-items:center;gap:3px;height:18px;margin-bottom:10px;">'
        f'<div class="wave-bar" style="width:3px;height:16px;border-radius:2px;background:{accent};transform-origin:center;animation-delay:0s;"></div>'
        f'<div class="wave-bar" style="width:3px;height:16px;border-radius:2px;background:{accent};transform-origin:center;animation-delay:0.12s;"></div>'
        f'<div class="wave-bar" style="width:3px;height:16px;border-radius:2px;background:{accent};transform-origin:center;animation-delay:0.24s;"></div>'
        f'<div class="wave-bar" style="width:3px;height:16px;border-radius:2px;background:{accent};transform-origin:center;animation-delay:0.36s;"></div>'
        f'<div class="wave-bar" style="width:3px;height:16px;border-radius:2px;background:{accent};transform-origin:center;animation-delay:0.48s;"></div>'
        f'</div>'
        f'<h2 style="margin:0 0 2px;font-family:Syne,sans-serif;font-size:1.1rem;font-weight:700;color:#F0F0F8;">{user_name}</h2>'
        f'<p class="status-text" style="margin:0;font-size:0.65rem;color:rgba(255,255,255,0.3);font-weight:500;text-transform:uppercase;letter-spacing:0.06em;"><span>LISTENING</span></p>'
        f'</div>'
    )
    st.markdown(html, unsafe_allow_html=True)
...
def render_active_avatar(
    ...
    html = (
        ...
        f'{img_tag}</div>'
        f'<div style="display:flex;justify-content:center;align-items:center;gap:3px;height:18px;margin-bottom:10px;">'
        f'<div class="wave-bar" style="width:3px;height:18px;border-radius:2px;background:{accent};transform-origin:center;animation-delay:0s;"></div>'
        f'<div class="wave-bar" style="width:3px;height:18px;border-radius:2px;background:{accent};transform-origin:center;animation-delay:0.1s;"></div>'
        f'<div class="wave-bar" style="width:3px;height:18px;border-radius:2px;background:{accent};transform-origin:center;animation-delay:0.2s;"></div>'
        f'<div class="wave-bar" style="width:3px;height:18px;border-radius:2px;background:{accent};transform-origin:center;animation-delay:0.3s;"></div>'
        f'<div class="wave-bar" style="width:3px;height:18px;border-radius:2px;background:{accent};transform-origin:center;animation-delay:0.4s;"></div>'
        f'<div class="wave-bar" style="width:3px;height:18px;border-radius:2px;background:{accent};transform-origin:center;animation-delay:0.5s;"></div>'
        f'<div class="wave-bar" style="width:3px;height:18px;border-radius:2px;background:{accent};transform-origin:center;animation-delay:0.6s;"></div>'
        f'</div>'
        ...
        f'<p class="status-text" style="margin:0;font-size:0.6rem;color:rgba(255,255,255,0.3);font-weight:500;text-transform:uppercase;letter-spacing:0.06em;"><span>LISTENING</span></p>'
        f'</div>'
    )
    st.markdown(html, unsafe_allow_html=True)
